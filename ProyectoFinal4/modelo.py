...
class Trie:
    """
    [Día 5] Implementación de la estructura de datos Trie (Árbol de Prefijos)
    para el autocompletado de nombres.
    """
    def __init__(self):
        self.root = TrieNode()
    ...
    def buscar_por_prefijo(self, prefijo):
        """
        Busca todos los nodos cuyos nombres comienzan con el prefijo dado.
        Retorna una lista de objetos Nodo.
        """
        node = self.root
    ...
    def _recolectar_nodos(self, node, resultados):
        """Función auxiliar recursiva para recolectar nodos."""
